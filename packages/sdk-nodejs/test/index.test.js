...
jest.unstable_mockModule("sdk-nodejs/src/uuid/rng.js", () => ({
  rng: jest.fn(),
}));
jest.unstable_mockModule("sdk-nodejs/src/httpRequestAdapter.js", () => ({
  httpRequestAdapterInstance: jest.fn(),
}));

const { Client } = await import("sdk-nodejs/src/index.js");
